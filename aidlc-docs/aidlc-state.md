...
**State Version**: 2.2
**Last Updated**: 2026-05-11T10:44:37Z
...
| Current Stage | **Functional Design（W0 bootstrap）** |
| 直前完了ステージ | Workflow Planning |
| 直前通過した承認ゲート | G5 — Workflow Execution Plan 承認（2026-05-11T10:44:37Z） |
| 待機中の承認 | （なし — W0 bootstrap Functional Design 着手可能） |
| 次アクション | Construction W0 bootstrap の Functional Design を開始する |
...
| 6 | INCEPTION | Units Generation | ✅ COMPLETE | 2026-05-11T10:29:51Z | `aidlc-docs/inception/application-design/unit-of-work.md` + `unit-of-work-dependency.md` + `unit-of-work-story-map.md` + `aidlc-docs/inception/plans/unit-of-work-plan.md` |
| 7 | INCEPTION | Workflow Planning | ✅ COMPLETE | 2026-05-11T10:44:37Z | `aidlc-docs/inception/plans/execution-plan.md` — G5 Approved |

### CONSTRUCTION フェーズ（🟢）

各ユニットごとの per-unit ステージ（Functional Design → NFR Requirements → NFR Design → Infrastructure Design → Code Generation）は、G5 承認後に `execution-plan.md` の W0-W6 順で展開する。

| # | Phase | Stage | Status |
|---|---|---|---|
| 8 | CONSTRUCTION | Functional Design（per unit） | ⏳ PENDING（次アクション: W0 bootstrap） |
...
| G5 | Workflow Execution Plan（`execution-plan.md`） | ✅ Approved | 2026-05-11T10:44:37Z |
...
└── inception/
    ├── plans/
    │   ├── execution-plan.md                         ← Workflow Planning 正本（G5 Approved）
    │   └── unit-of-work-plan.md                      ← Units Generation 正本
    ├── requirements/
    ...
    └── application-design/
        ...
        ├── unit-of-work.md                           ← Units Generation 正本
        ├── unit-of-work-dependency.md                ← Units Generation 正本
        └── unit-of-work-story-map.md                 ← Units Generation 正本
```
...
> **状態**: Units Generation 完了前のドラフト履歴。正式版は `aidlc-docs/inception/application-design/unit-of-work.md`、`unit-of-work-dependency.md`、`unit-of-work-story-map.md` を参照。
...
**実行すべきステージ**: Construction W0 bootstrap — Functional Design
...
- W0 bootstrap の Functional Design artifact
- W0 bootstrap に必要な NFR Requirements / NFR Design / Infrastructure Design / Code Plan の順次作成

**次の承認ゲート**: G6（W0 bootstrap の `code-plan.md` 承認時）。Code Generation 着手前に必須。
...
- [ ] `unit-of-work.md` / `unit-of-work-dependency.md` / `unit-of-work-story-map.md` / `unit-of-work-plan.md` を読んだか
- [ ] `execution-plan.md` が G5 承認済みか確認したか
